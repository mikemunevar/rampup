...
def Madlibs
	...
	puts "Once upon a time, there lived a young couple in a small but comfortable #{color} cottage.  Their names were #{male_name} and #{female_name}.  In their cottage they lived with a #{animal} and their #{number} children. One #{sky} morning..."
end
